# 🚂 동유럽 커플여행 V2 (부다페스트 · 비엔나 · 고사우 · 프라하)

**2026.09.11 ~ 09.22 · 11박 12일** — 부다페스트 2박 → 비엔나 3박 → 고사우 2박(린츠 픽업/반납 렌트카) → 프라하 4박.
체스키·프라하는 렌트카로 가지 않고, 알프스 구간만 렌트로 다녀오는 V2 최종안입니다.
...
- **현지에서(오프라인):**
  - **Google Maps** → 프로필 → *오프라인 지도* → 부다페스트·비엔나·잘츠카머구트·프라하 영역 미리 다운로드
